...
directories = ['/with_mask','/without_mask']
...
train_set = train_data.flow_from_directory(train_data_path, target_size=(224, 224), batch_size=BS, color_mode='grayscale', class_mode='categorical')
test_set = test_data.flow_from_directory(test_data_path, target_size=(224, 224), batch_size=BS, color_mode='grayscale', class_mode='categorical')
...
model_path = "facemask_detect7.h5"
