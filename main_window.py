...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("MainWindow", "Detect mask on face"))
        self.subMenu1.setText(_translate("MainWindow", "Face Detect"))
        self.subMenu2.setText(_translate("MainWindow", "Training model"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("MainWindow", "Recognition face no mask"))
