...
"")
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 214, 606))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
...
"}")
        ...
        self.widget_face_rec = QtWidgets.QWidget(self.mainBody_contain)
        self.widget_face_rec.setObjectName("widget_face_rec")
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.widget_face_rec)
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.lb_imgIn = QtWidgets.QLabel(self.widget_face_rec)
        self.lb_imgIn.setMinimumSize(QtCore.QSize(224, 224))
        self.lb_imgIn.setText("")
        self.lb_imgIn.setObjectName("lb_imgIn")
        self.horizontalLayout_11.addWidget(self.lb_imgIn, 0, QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.lbName = QtWidgets.QLabel(self.widget_face_rec)
        self.lbName.setMinimumSize(QtCore.QSize(200, 30))
        self.lbName.setText("")
        self.lbName.setObjectName("lbName")
        self.horizontalLayout_11.addWidget(self.lbName, 0, QtCore.Qt.AlignTop)
        self.lb_imgOut = QtWidgets.QLabel(self.widget_face_rec)
        self.lb_imgOut.setMinimumSize(QtCore.QSize(500, 500))
        self.lb_imgOut.setText("")
        self.lb_imgOut.setObjectName("lb_imgOut")
        self.horizontalLayout_11.addWidget(self.lb_imgOut)
        self.horizontalLayout_10.addWidget(self.widget_face_rec)
